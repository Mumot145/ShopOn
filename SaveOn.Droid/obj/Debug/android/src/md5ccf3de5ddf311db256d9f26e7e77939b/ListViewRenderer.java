...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MR.Gestures.Android.Renderers.ListViewRenderer, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", ListViewRenderer.class, __md_methods);
	}
	...
	public ListViewRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == ListViewRenderer.class)
			mono.android.TypeManager.Activate ("MR.Gestures.Android.Renderers.ListViewRenderer, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
