...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MR.Gestures.Android.Renderers.ContentViewRenderer, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", ContentViewRenderer.class, __md_methods);
	}


	public ContentViewRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == ContentViewRenderer.class)
			mono.android.TypeManager.Activate ("MR.Gestures.Android.Renderers.ContentViewRenderer, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public ContentViewRenderer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == ContentViewRenderer.class)
	...
	public ContentViewRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == ContentViewRenderer.class)
			mono.android.TypeManager.Activate ("MR.Gestures.Android.Renderers.ContentViewRenderer, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
