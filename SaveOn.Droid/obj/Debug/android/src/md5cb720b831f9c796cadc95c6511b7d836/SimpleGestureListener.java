...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MR.Gestures.Android.SimpleGestureListener, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", SimpleGestureListener.class, __md_methods);
	}


	public SimpleGestureListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SimpleGestureListener.class)
			mono.android.TypeManager.Activate ("MR.Gestures.Android.SimpleGestureListener, MR.Gestures.Android, Version=1.4.2.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
